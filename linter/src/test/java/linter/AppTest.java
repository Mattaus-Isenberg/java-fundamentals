...
{
    @Test public void JSLintEmptyFileTest()
    {
        String stringResult = "";
        Path testFile = Paths.get("src/main/resources/empty.js");
        assertEquals(stringResult, App.lintJavaScriptFile(testFile));
    }

    @Test public void JSLintNoErrorTest()
    {
        String stringResult = "";
    ...
    @Test public void JSLintOneErrorTest()
    {
        String stringResult = "Line 11: Missing semicolon.\n";
        Path testFile = Paths.get("src/main/resources/one-error.js");
        assertEquals(stringResult, App.lintJavaScriptFile(testFile));
    }

    @Test public void JSLintHandfulOfErrorsTest()
    {
        String stringResult =
    ...
    @Test public void JSLintFindAllErrorsTest()
    {
        String stringResult =
